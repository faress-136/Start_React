...
export default function Footer() {
  return (
   <>
   <footer className={cs(styles.myfooter, 'text-center')}>
        <div className="container">
            <div className="row">
                <div className="col-lg-4 mb-5 mb-lg-0">
                    <h4 className={`${styles.footer_text} text-uppercase mb-4`}>Location</h4>
   ...
   <div className={`${styles.credits} text-center py-4 text-white`}>
    <div className="container">
    <small className={styles.s_footer}>Copyright © Your Website 2022</small>
    </div>
   </div>
